...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:import href="plugin:org.oasis-open.dita.publishing:pdf/fo/xsl/oasis-spec-front-matter.xsl"/>
    <xsl:import href="plugin:org.oasis-open.dita.publishing:pdf/fo/xsl/oasis-spec-footers.xsl"/>
    <xsl:import href="plugin:org.oasis-open.dita.publishing:pdf/fo/attrs/oasis-spec-topic-attr.xsl"/>
    <xsl:import href="plugin:org.oasis-open.dita.publishing:pdf/fo/xsl/oasis-spec-custom-xsl.xsl"/>
